$(document).ready(function(){$('#sendform').on('submit',function(){$.ajax({type:'POST',url:'send.php',data:$(this).serialize(),success:function(data){alert('Ð¡Ð¿Ð°ÑÐ¸Ð±Ð¾ Ð·Ð° Ð·Ð°ÑÐ²ÐºÑƒ! Ð’ Ñ‚ÐµÑ‡ÐµÐ½Ð¸Ðµ 5-20 Ð¼Ð¸Ð½ÑƒÑ‚ Ð’Ð°Ð¼ Ð¿ÐµÑ€ÐµÐ·Ð²Ð¾Ð½Ð¸Ñ‚ Ð¿ÐµÑ€Ð²Ñ‹Ð¹ Ð¾ÑÐ²Ð¾Ð±Ð¾Ð´Ð¸Ð²ÑˆÐ¸Ð¹ÑÑ Ð¾Ð¿ÐµÑ€Ð°Ñ‚Ð¾Ñ€. Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ðµ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½!'); ym(63527578, 'reachGoal', 'citymobil'); setTimeout(function(){location.reload();},100); return true; }});});});
